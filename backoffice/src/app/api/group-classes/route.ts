...
export async function GET(request: NextRequest) {
    try {
        ...
        console.error('group-classes GET', { error });
        return NextResponse.json({ status: 0, message: 'Error al obtener clases grupales' }, { status: 500 });
    }
}
...
export async function POST(request: NextRequest) {
    try {
        ...
        console.error('group-classes POST', { error });
        return NextResponse.json({ status: 0, message: 'Error al crear clase grupal' }, { status: 500 });
    }
}

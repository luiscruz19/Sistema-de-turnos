...
export async function GET(request: NextRequest) {
    try {
        ...
        return NextResponse.json({ status: 0, message: 'Error al obtener clientes' }, { status: 500 });
    }
}
...
export async function POST(request: NextRequest) {
    try {
        ...
        return NextResponse.json({ status: 0, message: 'Error al crear cliente' }, { status: 500 });
    }
}

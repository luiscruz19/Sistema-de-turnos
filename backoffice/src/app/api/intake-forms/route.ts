...
export async function GET(request: NextRequest) {
    try {
        ...
        console.error('intake-forms GET', { error });
        return NextResponse.json({ status: 0, message: 'Error al obtener formularios' }, { status: 500 });
    }
}
...
export async function POST(request: NextRequest) {
    try {
        ...
        console.error('intake-forms POST', { error });
        return NextResponse.json({ status: 0, message: 'Error al crear formulario' }, { status: 500 });
    }
}

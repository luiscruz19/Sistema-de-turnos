...
export async function disconnect(req, res) {
    try {
        ...
        // STUB: el borrado del refresh_token/credenciales OAuth de Google se hace en la
        // capa de integraciones (integrations/google-calendar.js, fuera de este modulo).
        // Cuando esa capa exponga un deleteCredentials('google_calendar', scope),
        // invocarlo aca. Por ahora solo deshabilitamos el sync del profesional.
